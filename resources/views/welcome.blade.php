    ...
    <body class="antialiased bg-white text-gray-900 overflow-x-hidden">
        <div class="min-h-screen flex flex-col">
            ...
            <main class="flex-1">
              ...
              <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-0 pb-0 sm:pb-5 md:pb-8">
                @include('components.hero')
              </div>

      <!-- Features Section -->
      <div id="features" class="relative -mt-20 sm:-mt-12 md:-mt-16 lg:-mt-16 scroll-mt-24 sm:scroll-mt-28 bg-white">
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-1 sm:pt-6 pb-10">
