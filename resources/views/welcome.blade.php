...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased bg-white text-gray-900 overflow-x-hidden">
      ...
      <!-- Features Section -->
      <div id="features" class="relative mt-2 sm:-mt-6 md:-mt-12 lg:-mt-12 xl:-mt-6 2xl:mt-0 scroll-mt-24 sm:scroll-mt-28">
        <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-4 pb-10">
          ...
          <div class="mt-5 sm:mt-6 grid gap-4 sm:gap-6 md:grid-cols-3">
            <article class="bg-white rounded-2xl p-5 sm:p-6 shadow-sm border border-gray-100 card-hover reveal show text-center md:text-left">
              <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center bg-gradient-to-br from-indigo-500 to-purple-500 text-white mb-3 sm:mb-4 mx-auto md:mx-0">
            ...
            <article class="bg-white rounded-2xl p-5 sm:p-6 shadow-sm border border-gray-100 card-hover reveal show text-center md:text-left">
              <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center bg-gradient-to-br from-emerald-500 to-teal-500 text-white mb-3 sm:mb-4 mx-auto md:mx-0">
            ...
            <article class="bg-white rounded-2xl p-5 sm:p-6 shadow-sm border border-gray-100 card-hover reveal show text-center md:text-left">
              <div class="w-10 h-10 sm:w-12 sm:h-12 rounded-xl flex items-center justify-center bg-gradient-to-br from-pink-500 to-rose-500 text-white mb-3 sm:mb-4 mx-auto md:mx-0">
                  ...
                  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div>
                      ...
                      <ul class="space-y-2 text-white/90 text-sm">
                        ...
                        <li class="flex items-center gap-2">
                          ...
                          <span>Telepon/WA: 0821-7997-0473</span>
                        </li>
                      </ul>
                    </div>
                    ...
                    <div>
                      ...
                      <div class="flex items-center gap-3">
                        ...
                        <!-- WhatsApp -->
                        <a href="https://wa.me/6282179970473" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp Admin" class="w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center">
                        ...
                        <!-- YouTube (optional placeholder link) -->
                        <a href="#" aria-label="YouTube" class="w-9 h-9 rounded-full bg-white/10 hover:bg-white/20 flex items-center justify-center">
                          <svg class="w-5 h-5" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M23.498 6.186a2.999 2.999 0 00-2.115-2.12C19.641 3.5 12 3.5 12 3.5s-7.641 0-9.383.566A3 3 0 00.502 6.186C0 7.943 0 12 0 12s0 4.057.502 5.814a3 3 0 002.115 2.12C4.359 20.5 12 20.5 12 20.5s7.641 0 9.383-.566a3 3 0 002.115-2.12C24 16.057 24 12 24 12s0-4.057-.502-5.814zM9.75 15.5V8.5l6 3.5-6 3.5z"/></svg>
                        </a>
                      </div>
                    </div>
                  </div>
